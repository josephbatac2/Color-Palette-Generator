    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900 text-white font-sans py-12 px-6">
      <div className="max-w-3xl mx-auto backdrop-blur-xl bg-black/40 rounded-3xl border border-white/20 p-8 shadow-2xl">
        ...
        <main className="space-y-12">
          ...
          <section id="v1.5.2">
            <div className="mb-4">
              <h2 className="text-2xl font-semibold text-white">v1.5.2</h2>
              <time className="text-sm text-green-300 font-medium">September 1, 2026</time>
            </div>
            <ul className="space-y-3 text-gray-200">
              <li className="flex gap-3">
                <span className="text-green-400 mt-1">•</span>
                <span>
                  <strong className="text-white font-semibold">1,250 New Curated Palettes:</strong> Added 50 new palettes to each of 25 categories, bringing the total to over 4,600 palettes for even more creative inspiration.
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-green-400 mt-1">•</span>
